...
pub use commands::{
    ...
    __cmd__search_messages, __cmd__update_prompt_template, __cmd__validate_template_variables,
    chat_completion, chat_continue, chat_regenerate, create_prompt_template,
