...
pub use commands::{
    ...
    __cmd__reset_dynamic_summary_template, __cmd__update_prompt_template, chat_completion,
    ...
    reset_dynamic_memory_template, reset_dynamic_summary_template, update_prompt_template,
};
