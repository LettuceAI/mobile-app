...
const baseDemoCharacters: Array<Pick<Character, "id" | "name" | "description" | "style" | "boundaries" | "avatarPath">> = [
  {
    id: "demo-alice",
    name: "Alice",
    description: "A friendly and helpful AI assistant ready to keep conversations flowing.",
  ...
  },
  {
    id: "demo-bob",
    name: "Bob",
    description: "A witty creative partner who loves riffing on ideas.",
  ...
  },
  {
    id: "demo-cam",
    name: "Cam",
    description: "Focused study buddy for deep-dive learning sessions.",
