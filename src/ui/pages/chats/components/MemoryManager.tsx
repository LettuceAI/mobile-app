  ...
  return (
    <div className="space-y-4">
      ...
      <div className={cn(
        ...
        <p className={cn(typography.caption.size, "text-blue-200 leading-relaxed")}>
          💡 Memories are included in every message to help the AI maintain context and consistency throughout your conversation.
        </p>
      </div>
    </div>
  );
