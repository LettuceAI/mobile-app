                ...
                {selectedModel && (
                    <div className="space-y-4">
                        <div className="rounded-lg border border-white/10 bg-white/5 px-3 py-2">
                            <div className="flex items-center gap-2">
                                <span className="truncate text-sm font-medium text-white">{selectedModel.displayName || selectedModel.name}</span>
                        ...
                        <MenuButton
                            ...
                            onClick={() => {
                                if (confirm(`Are you sure you want to delete ${selectedModel.displayName || selectedModel.name}?`)) {
