            ...
            <div className="flex flex-col items-center max-w-md mx-auto w-full">
                ...
                <div className="w-full space-y-4 mb-8">
                    ...
                    <button
                        ...
                        className={cn(
                            "w-full text-left relative overflow-hidden group transition-all duration-300",
                            radius.lg,
                            "border p-1",
                        ...
                        <div className="relative p-5 z-10">
                            <div className="flex items-start justify-between mb-2">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold text-white">Dynamic Memory</h3>
                            ...
                            <p className="text-sm text-gray-400 mb-5 leading-relaxed pl-[52px]">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pl-[52px]">
                        ...
                        <div className="relative p-5 z-10">
                            <div className="flex items-start justify-between mb-2">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold text-white">Manual Memory</h3>
                                        <p className="text-xs text-gray-500 mt-0.5">Classic experience</p>
                                    </div>
                                </div>
                                <div className={cn(
                                    "w-6 h-6 rounded-full border flex items-center justify-center transition-all duration-300",
