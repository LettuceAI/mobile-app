...
/**
 * A prompt shown to users who have v1 of the embedding model installed,
 * encouraging them to upgrade to v2 with 4096 token support.
 */
export function EmbeddingUpgradePrompt({ onDismiss, returnTo }: EmbeddingUpgradePromptProps) {
                    ...
                    <div className="flex items-start justify-between gap-2">
                        <div>
                            <h3 className="font-semibold text-amber-200 text-base">
                                Embedding Model v2 Available
                            </h3>
                            <p className="mt-1.5 text-sm text-amber-200/70 leading-relaxed">
                                You're using v1 with 512 tokens. Upgrade to v2 for{" "}
                                <span className="font-semibold text-amber-100">4096 tokens</span>
